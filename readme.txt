...
* Added scroll-hint arrow at the bottom of the TOC when content overflows.
...
= 1.0.53 - 2026-01-22 =
* Change smart-toc-inline width.

= 1.0.52 - 2026-01-22 =
* Improved inline TOC layout with responsive width.
* Inline TOC is now right-aligned and expands from 60% to 80% when opened.
* Uses aria-expanded state and CSS :has() for a pure CSS solution with smooth transition.

= 1.0.51 - 2026-01-20 =
* Change toc-focus-outline.

= 1.0.50 - 2026-01-05 =
* Change position of mobile smart navigation.

= 1.0.49 - 2026-01-05 =
* Change position of mobile smart navigation.

= 1.0.48 - 2026-01-05 =
* Edit function getScrollOffset.

= 1.0.47 - 2025-12-19 =
* Change position of mobile smart navigation.

= 1.0.46 - 2025-11-21 =
* New width and scrollbar.
