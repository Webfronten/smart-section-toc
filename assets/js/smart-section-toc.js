setActiveLink(
    ...
    function () {
        ...
        function initSmartSectionTOC() {
            ...
            const headings = contentArea.querySelectorAll(
                settings.headingSelector,
            );
            ...
            function generateSlug(text) {
                ...
                return slugCounts[base] > 1
                    ? `${base}-${slugCounts[base]}`
                    : base;
            }
            ...
            if (!useScrollFallback && "IntersectionObserver" in window) {
                ...
                function highlightActiveSection() {
                    const scrollPosition =
                        window.scrollY + getScrollOffset() + 50;
